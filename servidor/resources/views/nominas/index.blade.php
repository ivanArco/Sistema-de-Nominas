    ...
    <div class="tarjeta" style="overflow-x:auto;">
        <table class="tabla">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="acciones">
                                ...
                                @if(auth()->user()?->tienePermiso('nominas.cierre.autorizar') && !$nomina->cierre_autorizado && $nomina->estatus !== 'CANCELADA')
                                    <form method="POST" action="{{ route('nominas.autorizar-cierre', $nomina->id) }}">
                                        @csrf
                                        @method('PATCH')
                                        <button class="boton" type="submit">Autorizar cierre</button>
                                    </form>
                                @endif
                ...
                @empty
                    <tr>
                        <td colspan="9">No hay nominas registradas.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
