        ...
        @auth
            <aside class="sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    @endif
                    @if(auth()->user()?->tienePermiso('autoservicio.ver'))
                        <a class="sidebar-link {{ request()->routeIs('mi-cuenta.*') ? 'activo' : '' }}" href="{{ route('mi-cuenta.index') }}">
                            <span class="izq"><span class="menu-icono"></span><span class="menu-texto">Mi cuenta</span></span>
                            <span class="menu-flecha">&gt;</span>
                        </a>
                    @endif
                    @if(auth()->user()?->tienePermiso('solicitudes.propias'))
                        <a class="sidebar-link {{ request()->routeIs('solicitudes.*') ? 'activo' : '' }}" href="{{ route('solicitudes.index') }}">
                            <span class="izq"><span class="menu-icono"></span><span class="menu-texto">Mis solicitudes</span></span>
                            <span class="menu-flecha">&gt;</span>
                        </a>
                    @endif
                    @if(auth()->user()?->tienePermiso('solicitudes.aprobar'))
                        <a class="sidebar-link {{ request()->routeIs('solicitudes.aprobacion.*') ? 'activo' : '' }}" href="{{ route('solicitudes.aprobacion.index') }}">
                            <span class="izq"><span class="menu-icono"></span><span class="menu-texto">Aprobacion solicitudes</span></span>
                            <span class="menu-flecha">&gt;</span>
                        </a>
                    @endif
                    ...
                    @if(auth()->user()?->tienePermiso('clientes.gestionar'))
                        <a class="sidebar-link {{ request()->routeIs('clientes.*') ? 'activo' : '' }}" href="{{ route('clientes.index') }}">
                            <span class="izq"><span class="menu-icono"></span><span class="menu-texto">Clientes y cuentas</span></span>
                            <span class="menu-flecha">&gt;</span>
                        </a>
                    @endif
                    @if(auth()->user()?->tienePermiso('empleados.gestionar'))
                        <a class="sidebar-link {{ request()->routeIs('empleados.*') ? 'activo' : '' }}" href="{{ route('empleados.index') }}">
                            <span class="izq"><span class="menu-icono"></span><span class="menu-texto">Personal activo</span></span>
                            <span class="menu-flecha">&gt;</span>
                        </a>
                    @endif
                    @if(auth()->user()?->tienePermiso('catalogos_nomina.gestionar'))
                    ...
                    @endif
                    @if(auth()->user()?->tienePermiso('incidencias.gestionar'))
                    ...
                    @endif
                    @if(auth()->user()?->tienePermiso('asistencias.gestionar'))
                        <a class="sidebar-link {{ request()->routeIs('asistencias.*') ? 'activo' : '' }}" href="{{ route('asistencias.index') }}">
                            <span class="izq"><span class="menu-icono"></span><span class="menu-texto">Asistencias</span></span>
                            <span class="menu-flecha">&gt;</span>
                        </a>
                    @endif
                    @if(auth()->user()?->tienePermiso('expedientes.gestionar'))
                        <a class="sidebar-link {{ request()->routeIs('expedientes.*') ? 'activo' : '' }}" href="{{ route('expedientes.index') }}">
                            <span class="izq"><span class="menu-icono"></span><span class="menu-texto">Expedientes</span></span>
                            <span class="menu-flecha">&gt;</span>
                        </a>
                    @endif
                    @if(auth()->user()?->tienePermiso('ventas.gestionar') || auth()->user()?->tienePermiso('ventas.propias'))
                        <a class="sidebar-link {{ request()->routeIs('ventas.*') ? 'activo' : '' }}" href="{{ route('ventas.index') }}">
                            <span class="izq"><span class="menu-icono"></span><span class="menu-texto">Ventas y comisiones</span></span>
                            <span class="menu-flecha">&gt;</span>
                        </a>
                    @endif
                    ...
                    @endif
                    @if(auth()->user()?->tienePermiso('evaluaciones.gestionar'))
                        <a class="sidebar-link {{ request()->routeIs('evaluaciones.*') ? 'activo' : '' }}" href="{{ route('evaluaciones.index') }}">
                            <span class="izq"><span class="menu-icono"></span><span class="menu-texto">Evaluaciones</span></span>
                            <span class="menu-flecha">&gt;</span>
                        </a>
                    @endif
                    @if(auth()->user()?->tienePermiso('nominas.gestionar'))
