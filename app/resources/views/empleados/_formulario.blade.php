<div class="grilla">
    ...
    <div>
        ...
        <input type="number" step="0.01" name="sal_dia" value="{{ old('sal_dia', $empleado->sal_dia ?? '') }}" required>
    </div>
    <div>
        <label>Salario integrado</label>
        <input type="number" step="0.01" name="sal_int" value="{{ old('sal_int', $empleado->sal_int ?? '') }}" required>
    </div>
    <div>
