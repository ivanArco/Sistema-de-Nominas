    ...
    <div class="dash-shell">
        ...
        <div class="dash-layout">
            <aside class="dash-nav">
                <h3>Modulos</h3>
                <a href="{{ route('usuarios.index') }}">Usuarios y accesos</a>
                <a href="{{ route('clientes.index') }}">Clientes y cuentas</a>
                <a href="{{ route('empleados.index') }}">Personal activo</a>
                <a href="{{ route('catalogos-nomina.index') }}">Catalogos de nomina</a>
